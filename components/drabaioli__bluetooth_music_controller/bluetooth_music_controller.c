#include "bluetooth_music_controller.h"
...
static void bt_av_hdl_stack_evt(uint16_t event, void *p_param)
{
  ...
  switch (event) {
    ...
    case BT_APP_EVT_STACK_UP: {
      esp_bt_dev_set_device_name(BLUETOOTH_CONTROLLER_DEVICE_NAME);
...
void setup_bluetooth_controller(void)
{
  ...
  /*
   * This module only uses the functions of Classical Bluetooth.
